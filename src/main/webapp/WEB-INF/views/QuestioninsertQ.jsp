				...
				<div class="row">
					<div class="card d-inline-block h-100 shadow mt-3 mb-3 overflow-hidden">
						<div class="card-body">
							...
							<form id="qstnInsert" role="form" action="Questioninsert" method="post" enctype="multipart/form-data">
								<div class="noticeGrid">
									...
									<div class="two">
										<textarea onkeydown="resize(this)" onkeyup="resize(this)" style="width:665px; min-height:180px;" class="form-control" id="qstnContent" name="qstnContent" placeholder="내용"></textarea>
									</div>
